var app = {
    ...
    themePanel: {
      ...
      themeHeader: { class: 'app-header-inverse', toggleAttr: 'name="app-header-inverse"', cookieName: 'app-theme-header' },
      themeHeaderFixed: {
  ...
  generateScrollbar = function (e) {
    ...
    if (!(e.scrollbarInit || (app.isMobile && e.getAttribute(app.scrollBar.skipMobileAttr)))) {
      ...
      if (((e.style.height = a), (e.scrollbarInit = !0), app.isMobile)) e.style.overflowX = 'scroll';
        ...
        e.closest('.' + app.sidebar.class + ':not(.' + app.sidebarEnd.class + ')') &&
        0 !== e.closest('.' + app.sidebar.class + ':not(.' + app.sidebarEnd.class + ')').length
  ...
  handlePanelAction = function () {
    ...
    [].slice.call(document.querySelectorAll('[' + app.panel.toggle.remove.attr + ']')).map(function (a) {
      (a.onmouseover = function (a) {
        ...
        bootstrap &&
        ((e = new bootstrap.Tooltip(this, { title: app.panel.toggle.remove.tooltipText, placement: 'bottom' })).show(),
      ...
      [].slice.call(document.querySelectorAll('[' + app.panel.toggle.collapse.attr + ']')).map(function (a) {
        (a.onmouseover = function (a) {
          !this.hasAttribute('data-tooltip-init') &&
          bootstrap &&
          ((e = new bootstrap.Tooltip(this, { title: app.panel.toggle.collapse.tooltipText, placement: 'bottom' })).show(),
            this.setAttribute('data-tooltip-init', !0));
        }),
      ...
      [].slice.call(document.querySelectorAll('[' + app.panel.toggle.reload.attr + ']')).map(function (a) {
        (a.onmouseover = function (a) {
          !this.hasAttribute('data-tooltip-init') &&
          bootstrap &&
          ((e = new bootstrap.Tooltip(this, { title: app.panel.toggle.reload.tooltipText, placement: 'bottom' })).show(),
            this.setAttribute('data-tooltip-init', !0));
        }),
          (a.onclick = function (a) {
      ...
      [].slice.call(document.querySelectorAll('[' + app.panel.toggle.expand.attr + ']')).map(function (a) {
        (a.onmouseover = function () {
          !this.hasAttribute('data-tooltip-init') &&
          bootstrap &&
          ((e = new bootstrap.Tooltip(this, { title: app.panel.toggle.expand.tooltipText, placement: 'bottom' })).show(),
            this.setAttribute('data-tooltip-init', !0));
        }),
          (a.onclick = function (a) {
            a.preventDefault(), e && e.hide();
  ...
  handleScrollToTopButton = function () {
    ...
    (document.body.onscroll = function () {
      ...
      (e >= app.scrollToTopBtn.heightShow
        ? a.classList.contains(app.scrollToTopBtn.showClass) || a.classList.add(app.scrollToTopBtn.showClass)
  ...
  handleThemePanel = function () {
    ...
    e.map(function (e) {
      e.onclick = function () {
        ...
        a && document.body.classList.add(a),
          [].slice
            .call(document.querySelectorAll('.' + app.themePanel.class + ' [' + app.themePanel.theme.toggleAttr + ']'))
            .map(function (a) {
              a != e
                ? a.closest('.' + app.themePanel.themeListItemCLass).classList.remove(app.themePanel.theme.activeClass)
                : a.closest('.' + app.themePanel.themeListItemCLass).classList.add(app.themePanel.theme.activeClass);
            }),
    ...
    (a.onchange = function () {
      ...
      (e = [].slice.call(document.querySelectorAll('.' + app.themePanel.class + ' [' + app.themePanel.themeDarkMode.toggleAttr + ']'))).map(
        function (e) {
          e.onchange = function () {
            this.checked
    ...
    (a = document.querySelector('.' + app.themePanel.class + ' [' + app.themePanel.themeDarkMode.toggleAttr + ']')) &&
    ...
    function a() {
      ...
      e.map(function (e) {
        !(function (e, a) {
          ...
          (t = e
            .querySelector('.' + app.bootstrap.nav.tabs.itemClass + ' .' + app.bootstrap.nav.tabs.activeClass)
          ...
          if (
            ...
            (m.style.transitionProperty = 'height, margin, padding'),
              (m.style.transitionDuration = n + 'ms'),
    ...
    function e(e, a) {
      ...
      switch (
        ...
        case 'prev':
          var d;
          (d = -r) <= i
            ? (t.querySelector('.' + app.topMenu.control.class + '.' + app.topMenu.control.buttonPrev.class).classList.remove('show'),
              (p = 0))
            : (p = d - i + 88),
            (t.style.transitionProperty = 'height, margin, padding'),
            (t.style.transitionDuration = app.animation.speed + 'ms'),
    ...
    function a() {
      ...
      if (e) {
        var a = window.getComputedStyle(e),
          ...
          r = 0,
          i = [].slice.call(
            document.querySelectorAll('.' + app.topMenu.class + ' .' + app.topMenu.menu.class + ' > .' + app.topMenu.menu.itemClass)
          );
        if (i) {
          var n = !1;
          i.map(function (e) {
            e.classList.contains('menu-control') ||
            ((r += e.clientWidth), n || (o += e.clientWidth), e.classList.contains('active') && (n = !0));
          });
        }
        if (o >= l) {
          var p = o - l + 128;
  ...
  handleTopMenuSubMenu = function () {
    'use strict';
    var e =
        '.' + app.topMenu.class + ' .' + app.topMenu.menu.class + ' > .' + app.topMenu.menu.itemClass + '.' + app.topMenu.menu.hasSubClass,
  ...
  handleToggleNavProfile = function () {
    ...
    (e.onclick = function (e) {
      ...
      s &&
      ('block' == s.style.display ? t.classList.remove(app.sidebar.menu.activeClass) : t.classList.add(app.sidebar.menu.activeClass),
        slideToggle(s, l),
        ...
        if (e && e.classList.contains(app.sidebar.minify.toggledClass)) {
          ...
          if (t) {
            var s = getComputedStyle(document.body),
              ...
              r =
                e.classList.contains(app.sidebarEnd.class) || 'rtl' == s.getPropertyValue('direction')
                  ? document.body.clientWidth - l.left
                  : l.left + o,
            ...
            if (document.querySelector(app.sidebar.floatSubmenu.id)) {
              ...
              f.setAttribute('id', app.sidebar.floatSubmenu.id.replace('#', '')),
                f.setAttribute('class', app.sidebar.floatSubmenu.container.class),
                f.setAttribute('data-offset-top', n),
                f.setAttribute('data-menu-offset-top', n),
                (f.innerHTML =
                  '\t<div class="' +
            ...
            (i = document.querySelector(app.sidebar.floatSubmenu.id).clientHeight),
              (m = document.querySelector(app.sidebar.floatSubmenu.id));
            var v = document.querySelector(app.sidebar.floatSubmenu.arrow.id),
              S = document.querySelector(app.sidebar.floatSubmenu.line.id);
            if (d - n > i)
              m && ((m.style.top = n + 'px'), (m.style.left = p + 'px'), (m.style.bottom = 'auto'), (m.style.right = c + 'px')),
              v && ((v.style.top = '20px'), (v.style.bottom = 'auto')),
              S && ((S.style.top = '20px'), (S.style.bottom = 'auto'));
            else {
              var C = d - n - 21;
              m && ((m.style.top = 'auto'), (m.style.left = p + 'px'), (m.style.bottom = 0), (m.style.right = c + 'px')),
              v && ((v.style.top = 'auto'), (v.style.bottom = C + 'px')),
              S && ((S.style.top = '20px'), (S.style.bottom = C + 'px'));
            }
    ...
    return {
      ...
      renderAjax: function (a, t, s) {
        ...
        if (l) {
          ...
          t &&
          ((i = t.getAttribute('data-type') ? t.getAttribute('data-type') : i),
            (targetDataDataType = t.getAttribute('data-data-type') ? t.getAttribute('data-data-type') : i));
          var n = new XMLHttpRequest();
          (n.onreadystatechange = function () {
            n.readyState == XMLHttpRequest.DONE &&
            (200 == n.status
              ? setInnerHTML(l, n.responseText)
              : 400 == n.status
                ? (console.log('There was an error 400'), setInnerHTML(l, emptyHtml))
  ...
  handleSetPageOption = function (e) {
    ...
    if (a) {
      var t;
      if (
        (e.appContentFullHeight && a.classList.add(app.content.fullHeight.class),
        e.appSidebarLight && a.classList.add(app.layout.sidebarLight.class),
        ...
        (t = document.querySelector('.' + app.header.class + ' [' + app.sidebarEnd.mobile.toggleAttr + ']')) &&
        t.classList.remove(app.helper.display.none),
        (t = document.querySelector('.' + app.header.class + ' .' + app.header.brand.class)) &&
        t.classList.remove(app.helper.margin.left[0]);
      if ((e.appSidebarTransparent && a.classList.add(app.sidebar.transparent.class), e.appSidebarSearch))
        (t = document.querySelector('.' + app.sidebar.class + ' .' + app.sidebar.search.class)) &&
        t.classList.remove(app.sidebar.search.hideClass);
      if ((e.appSidebarHover && a.classList.add(app.sidebar.hover.class), e.appTopMenu))
        a.classList.add(app.layout.topMenu.class),
        (t = document.querySelector('.' + app.header.class + ' [' + app.topMenu.mobile.toggleAttr + ']')) &&
        t.classList.remove(app.helper.display.none);
      if (e.appWithoutHeader)
        a.classList.add(app.layout.withoutHeader.class), (t = document.querySelector('.' + app.header.class)) && (t.style.display = 'none');
      if (e.appWithoutSidebar)
        a.classList.add(app.layout.withoutSidebar.class),
        (t = document.querySelector('.' + app.header.class + ' [' + app.sidebar.mobile.toggleAttr + ']')) &&
        t.classList.add(app.helper.display.none),
        (t = document.querySelector('.' + app.sidebar.class)) && (t.style.display = 'none'),
        (t = document.querySelector('.' + app.sidebar.bg.class)) && (t.style.display = 'none'),
        (t = document.querySelector('.' + app.sidebar.mobile.backdrop.class)) && (t.style.display = 'none');
      ...
      if (e.appClass) for (var s = e.appClass.split(' '), l = 0; l < s.length; l++) a.classList.add(s[l]);
      ...
      if (e.bodyClass) for (s = e.bodyClass.split(' '), l = 0; l < s.length; l++) document.body.classList.add(s[l]);
  ...
  handleClearPageOption = function (e) {
    ...
    if (a) {
      var t;
      if (
        (e.appContentFullHeight && a.classList.remove(app.content.fullHeight.class),
        e.appSidebarLight && a.classList.remove(app.layout.sidebarLight.class),
        ...
        t.classList.add(app.helper.display.none),
        (t = document.querySelector('.' + app.header.class + ' .' + app.header.brand.class)) &&
        t.classList.add(app.helper.margin.left[0]);
      if (e.appSidebarTransparent)
        (t = document.querySelector('.' + app.sidebar.class)) && t.classList.remove(app.sidebar.transparent.class);
      if (e.appSidebarSearch)
        (t = document.querySelector('.' + app.sidebar.class + ' .' + app.sidebar.search.class)) &&
        t.classList.add(app.sidebar.search.hideClass);
      ...
      if (e.appWithoutSidebar)
        ...
        (t = document.querySelector('.' + app.header.class + ' [' + app.sidebar.mobile.toggleAttr + ']')) &&
        t.classList.remove(app.helper.display.none),
        (t = document.querySelector('.' + app.sidebar.class)) && t.removeAttribute('style'),
        (t = document.querySelector('.' + app.sidebar.bg.class)) && t.removeAttribute('style'),
        (t = document.querySelector('.' + app.sidebar.mobile.backdrop.class)) && t.removeAttribute('style');
      if (e.appWithoutHeader)
        a.classList.remove(app.layout.withoutHeader.class),
        (t = document.querySelector('.' + app.header.class)) && t.removeAttribute('style');
      ...
      if (e.appClass) for (s = e.appClass.split(' '), l = 0; l < s.length; l++) a.classList.remove(s[l]);
      if (e.bodyClass) for (s = e.bodyClass.split(' '), l = 0; l < s.length; l++) document.body.classList.remove(s[l]);
    ...
    e.map(function (e) {
      e.onkeyup = function () {
        ...
        (a = a.toLowerCase())
          ...
          (e = [].slice.call(
            document.querySelectorAll('.' + app.sidebar.class + ':not(.' + app.sidebarEnd.class + ') .' + app.sidebar.search.foundClass)
          )) &&
          e.map(function (e) {
            e.classList.remove(app.sidebar.search.foundClass);
          }),
          (e = [].slice.call(
            document.querySelectorAll('.' + app.sidebar.class + ':not(.' + app.sidebarEnd.class + ') .' + app.sidebar.menu.expandClass)
          )) &&
          e.map(function (e) {
          ...
          e.map(function (e) {
            ...
            if ((t = t.toLowerCase()).search(a) > -1) {
              ...
              if (
                ...
                (s.classList.remove(app.sidebar.search.hideClass), s.classList.add(app.sidebar.search.foundClass)),
                  (s = e.closest('.' + app.sidebar.menu.itemClass + '.' + app.sidebar.menu.hasSubClass)))
              )
                (s = s.querySelector(
                  '.' + app.sidebar.menu.submenu.class + ' .' + app.sidebar.menu.itemClass + '.' + app.sidebar.search.hideClass
                )) && s.classList.remove(app.sidebar.search.hideClass);
              if ((s = e.closest('.' + app.sidebar.menu.submenu.class)))
                if (
                  ((s.style.display = 'block'),
                  (s = s.querySelector('.' + app.sidebar.menu.itemClass + ':not(.' + app.sidebar.search.foundClass + ')')) &&
  ...
  hexToRgba = function (e, a = 1, t = !1) {
    ...
    if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(e))
      return (
        3 == (s = e.substring(1).split('')).length && (s = [s[0], s[0], s[1], s[1], s[2], s[2]]),
